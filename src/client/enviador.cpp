    ...
    try {
        ...
        while(cont){
            ...
            if (comando == "Presionando izquierda") {
                cont = protocolo.moverGusano(0, INICIO_IZQ);
            } else if (comando == "Presionando derecha") {
                cont = protocolo.moverGusano(0, INICIO_DER);
            } else if (comando == "Soltando izquierda") {
                cont = protocolo.moverGusano(0, FIN_IZQ);
            } else if (comando == "Soltando derecha") {
                cont = protocolo.moverGusano(0, FIN_DER);
            } else {
